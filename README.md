...
O dataset analisado possui 569 amostras e 33 colunas, sendo a variável alvo diagnosis, que indica se o tumor é Benigno (B) ou Maligno (M). Durante a análise inicial, foram observados os seguintes pontos:
